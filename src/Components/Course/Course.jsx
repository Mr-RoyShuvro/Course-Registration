...
const Course = ({ course, handleAddToBookmarks }) => {
    ...
    return (
        <div className='rounded-2xl bg-white px-4 pt-4 pb-4'>
            ...
            <div className=''>
                <button onClick={()=> handleAddToBookmarks(course)} className='w-full text-xl py-2 px-5 bg-blue-500 text-white font-semibold rounded-xl shadow-md hover:bg-blue-700 focus:outline-none focus:ring focus:ring-violet-400 focus:ring-opacity-75'>Select</button>
            </div>
        </div>
    );
};
